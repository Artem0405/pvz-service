...
// UserRepoMock is an autogenerated mock type for the UserRepository type
type UserRepoMock struct {
	mock.Mock
}

// CreateUser provides a mock function with given fields: ctx, user
func (_m *UserRepoMock) CreateUser(ctx context.Context, user domain.User) (uuid.UUID, error) {
...
func (_m *UserRepoMock) GetUserByEmail(ctx context.Context, email string) (domain.User, error) {
